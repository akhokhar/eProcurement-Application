            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="page-header">
                        <h1>Frontend Pages <small>edit frontend pages</small></h1>
                    </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="product_policy_box" class="summernote form-control" rows="5"><?php echo $view_page->page_content; ?></div>
                                    </div>
                                </div>
    ...
    jQuery(document).ready(function () {
		...
		height: "200px"
         ...
         $('#submit_btn').click(function() {
            ...
            $('textarea[name="page_content"]').html($('#product_policy_box').code());
           });
    });

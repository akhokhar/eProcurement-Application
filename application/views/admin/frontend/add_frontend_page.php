            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="page-header">
                        <h1>Frontend Pages <small>add frontend pages</small></h1>
                    </div>
                        ...
                        ?>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="page_content" id="page_content" class="summernote form-control" rows="5"></textarea>
                                    </div>
                                </div>
    ...
    jQuery(document).ready(function () {
		...
		height: "200px"
         ...
         $('#submit_btn').click(function() {
            ...
            $('textarea[name="page_content"]').html($('#page_content').code());
           });
    });

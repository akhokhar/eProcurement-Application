            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="page-header row">
                        <h1 class="col-sm-6">Change User Password <small></small></h1>
                    </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="userEmail" value="<?php echo $user[$this->flexi_auth->db_column('user_acc', 'email')]; ?>">
                                    
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="form-field-1">
                                        New Password <span class="validField">*</span>
                                    </label>
                                    <div class="col-sm-7">
                                        <?php
                                        $input_data = array(
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="form-field-1">
                                        Confirm New Password <span class="validField">*</span>
                                    </label>
                                    <div class="col-sm-7">
                                        <?php
                                        $input_data = array(
    ...
    var FormValidator = function () {
        ...
        var addProductForm = function () {
            ...
            $('#search_form').validate({
                ...
                messages: {
                    new_password: "Please enter New Password more than 8 charecters",
                    confirm_new_password: "Please enter Confirm New Password more than 8 charecters",
                },

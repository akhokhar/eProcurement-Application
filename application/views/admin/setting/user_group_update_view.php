                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        $input_data = array(
                                            ...
                                            'id' => 'group',
                                            'value' => set_value('update_group_name', $group[$this->flexi_auth->db_column('user_group', 'name')]),
                                            'class' => 'form-control',
                                            'placeholder' => ''
                                        );
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="form-field-1">
                                        Group Description <span class="validField">*</span>
                                    </label>
                                    <div class="col-sm-7">
                                        <textarea id="description" name="update_group_description" class="form-control"><?php echo set_value('update_group_description', $group[$this->flexi_auth->db_column('user_group', 'description')]); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="form-field-1">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <input type="checkbox" id="admin" name="update_group_admin" value="1" <?php echo set_checkbox('update_group_admin', 1, $ugrp_admin); ?> class=""/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="form-field-1">
                            ...
                            <div class="form-group">
                                <div class="col-sm-2 pull-right">
                                    <input type="hidden" value="Submit" name="update_user_group">
    ...
    var FormValidator = function () {
        ...
        var addProductForm = function () {
            ...
            $('#search_form').validate({
                ...
                messages: {
                    update_group_name: "Please enter Group Name",
                    update_group_description: "Please enter Group Description",

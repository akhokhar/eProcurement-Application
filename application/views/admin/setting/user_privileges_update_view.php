                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2 pull-left">
                                        <a href="<?php echo $base_url; ?>auth_admin/update_user_account/<?php echo $user['upro_uacc_fk']; ?>" class="btn btn-info ladda-button">Update Users Account</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-bordered table-hover table-full-width" id="">
                                    ...
                                    <?php foreach ($privileges as $privilege) { ?>
                                        <tr>
                                            ...
                                            <td class="align_ctr">
                                                ...
                                                <input type="checkbox" id="parent_<?php echo $privilege[$this->flexi_auth->db_column('user_privileges', 'id')]; ?>" class="delete_group" name="update[<?php echo $privilege[$this->flexi_auth->db_column('user_privileges', 'id')]; ?>][new_status]" value="1" <?php echo $new_status ?>/>
                                            </td>
                                            <td class="align_ctr">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align_ctr">
                                                <?php
                                                // Define form input values.
                                                $current_status = (in_array($value[$this->flexi_auth->db_column('user_privileges', 'id')], $user_privileges)) ? 1 : 0;
                                                $new_status = (in_array($value[$this->flexi_auth->db_column('user_privileges', 'id')], $user_privileges)) ? 'checked="checked"' : NULL;
                                                ?>
                                                ...
                                                <input type="checkbox" get_id="<?php echo $privilege[$this->flexi_auth->db_column('user_privileges', 'id')]; ?>" class="delete_group child_<?php echo $privilege[$this->flexi_auth->db_column('user_privileges', 'id')]; ?>" name="update[<?php echo $value[$this->flexi_auth->db_column('user_privileges', 'id')]; ?>][new_status]" value="1" <?php echo $new_status ?>/>
                                            </td>
                                            <td class="align_ctr">
                                                <?php echo (in_array($value[$this->flexi_auth->db_column('user_privileges', 'id')], $group_privileges) ? 'Yes' : 'No'); ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        <?php } ?>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="4">
                                            <input type="submit" name="update_user_privilege" value="Update User Privileges" class="btn btn-blue delete"/>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>

            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="page-header row">
                        <h1 class="col-sm-6">View all Goods Receivings</h1>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php
                            $attributes = array('class' => 'form-horizontal', 'role' => 'grn_form', 'id' => 'grn_form');
...
<script>
    ...
    $(function () {
        $('#order_table').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "<?php echo base_url(); ?>admin/server_datatables/get_grns",
                "type": "POST",
                "data": function ( d ) {
                    var top_search_like = {
            ...
            $('tr td:nth-child(1), tr td:nth-child(6)').each(function (){

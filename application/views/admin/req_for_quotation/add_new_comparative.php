                                        ...
                                        ?>
                                            <div class="panel-body">
												<div class="row">
													...
													<?php foreach($rfqVendors as $vendor){?>
													<div class="col-md-2"><?php echo $vendor['vendor_name']?></div>
													<?php }?>
												</div>
											...
											<input type="hidden" name="item[<?php echo $count;?>]" value="<?php echo $item['requisition_item_id']?>">
													...
													<?php for($i = 1; $i <= count($rfqVendors); $i++){ ?>
														<div class="col-md-2">
															<div class="form-group">
																 <?php $vendorId = $rfqVendors[$i-1]['vendor_id'];
																  $input_data = array(
																			'type'          => 'number',

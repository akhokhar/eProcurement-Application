            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="page-header row">
                        <h1 class="col-sm-6">View all Vendors</h1>
						<!-- start: ADD NEW VENDOR -->
                        <?php if ($this->flexi_auth->is_privileged($add_vendor)) { ?>
                            <div class="col-md-2 pull-right">
                                <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/vendor/add">
                                    Add New Vendor
                                </a>
                            </div>
                        <?php } ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php
                            $attributes = array('class' => 'form-horizontal', 'role' => 'vendor_form', 'id' => 'vendor_form');
...
<script>
    ...
    $(function () {
        $('#order_table').DataTable({
            ...
            "searching": false,
            "ajax": {
                "url": "<?php echo base_url(); ?>admin/server_datatables/get_vendors",
                "type": "POST",
                "data": null,
            },
            "order": [[ 1, "desc" ]],

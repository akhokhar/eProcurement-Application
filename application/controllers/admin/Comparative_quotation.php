...
class Comparative_Quotation extends CI_Controller {
   ...
   */
    function add($rfq_id) {
		...
		foreach($vendor_ids as $vendor_id) {
			$vendors[] = $this->general_model->list_vendors(true, array('vendor_id'), array($vendor_id));
		}
        $this->data['vendors'] = $vendors;
        $this->load->view('admin/includes/header', $this->data);
        $this->load->view('admin/comparative_quotation/add_new_comparative', $this->data);

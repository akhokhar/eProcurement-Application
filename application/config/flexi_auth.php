...
*/
	...
	*/ 
	...
	$config['database']['user_group']['columns']['admin'] = 'ugrp_admin';
        $config['database']['user_group']['columns']['active'] = 'ugrp_active';
	
	###++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++###
	
	
        /**
	 * User Privilege Table Menu
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_privileges']['table'] = 'system_menu_privileges';
	$config['database']['user_privileges']['columns']['id'] = 'mu_id';
	$config['database']['user_privileges']['columns']['name'] = 'mu_title';
        $config['database']['user_privileges']['columns']['parent'] = 'mu_parent_id';
        $config['database']['user_privileges']['columns']['active'] = 'mu_active';
        $config['database']['user_privileges']['columns']['delete'] = 'mu_delete';
        
	//$config['database']['user_privileges']['columns']['description'] = 'mu_url';
        
        
        
        	/**
	 * User Privilege Users Table MENU
	...
	*/ 
	...
	$config['database']['user_privilege_users']['columns']['privilege_id'] = 'upriv_users_menu_fk';
        
        
        
        
        /**
	 * User Privilege Groups Table MENU
	...
	*/ 
	...
	$config['database']['user_privilege_groups']['columns']['privilege_id'] = 'upriv_groups_menu_fk';
	...
	*/
	...
	/**
	 * Set the id of the Master admin group 
	 * @param: int
	*/
	$config['settings']['master_admin_group_id'] = 3;
